...
def reverse2wholeimage(b_align_crop_tenor_list,swaped_imgs, mats, crop_size, oriimg, logoclass, save_path = '', \
    ...
    for swaped_img, mat ,source_img in zip(swaped_imgs, mats,b_align_crop_tenor_list):
        ...
        del out, source_img_512, parsing, vis_parsing_anno
        ...
        if tgt_mask.sum() >= 5000:
            ...
            del tgt_mask, target_mask, swaped_img
    ...
    print(f'Saving result of the faceswap to: {save_path}')
    cv2.imwrite(save_path, final_img)


    del final_img, img, img_mask_list, target_image_list, img_white, swaped_imgs, b_align_crop_tenor_list, smooth_mask
